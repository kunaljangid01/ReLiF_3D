...
> **Note:** Please ensure that dataset use follows the license and access terms of the original BraTS 2019 and Left Atrium datasets. 
...
The LA dataset should be placed under:

```bash
data/2018LA_Seg_Training_Set/
```
...
If you use the provided split files, keep the labeled-volume setting consistent with the paper by setting `--labeled_num` to `1`, `2`, `3`, or `5`.
