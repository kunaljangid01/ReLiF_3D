...
class unet_3D(nn.Module):
    ...
    def forward_features(self, inputs):
        """
        Returns feature embeddings before decoding (center block).
        Used for prototype similarity in Class-Aware Prompt Memory.
        """
        conv1 = self.conv1(inputs)
        maxpool1 = self.maxpool1(conv1)
        ...
        center = self.center(maxpool4)  # shape: [B, C, D/16, H/16, W/16]
        return center
